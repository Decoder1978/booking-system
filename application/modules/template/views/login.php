...
<head>
    ...
    <title><?php echo(!empty($setting->title) ? $setting->title : null) ?>
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="text-right">
                    <a href="" data-toggle="modal" data-target="#for_gott_password"
                       style="color:#0B2161"><?php echo display('forgot_password') ?> ??</a>
                </div>
            </div>
